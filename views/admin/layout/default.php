...
<body class="d-flex flex-column">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a href="<?= $router->url('admin') ?>" class="navbar-brand"><?= $logo ?? 'AG' ?></a>
        ...
        <div class="collapse navbar-collapse" id="reponsiveNav">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= $router->url('admin_posts') ?>">Articles <i class="fas fa-newspaper"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= $router->url('admin_categories') ?>">Catégories <i class="fas fa-align-left"></i></a>
                </li>
            </ul>
